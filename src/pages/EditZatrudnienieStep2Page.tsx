...
export default function EditZatrudnienieStep2Page() {
  ...
  useEffect(() => {
    // Sprawdź czy mamy dane z poprzedniej strony
    if (location.state) {
      const prevData = location.state as any;
      setForm(prev => ({ ...prev, ...prevData }));
    }
  ...
  const handleBack = () => {
    navigate(`/edytuj-zatrudnienie/${id}`, { state: form });
  };
  ...
  return (
    <div style={{ padding: '1rem', maxWidth: '900px', margin: '0 auto' }}>
      <h2 style={{ color: '#0066cc', marginBottom: '1.5rem' }}>
        (2) Edycja zatrudnionego personelu medycznego
      </h2>
      ...
      <div style={{ 
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '200px 1fr', gap: '0.75rem', alignItems: 'center' }}>
          ...
          <label style={{ fontWeight: 'normal' }}>Kod techniczny:</label>
          <div style={{ color: '#666', fontSize: '14px' }}>146728</div>
